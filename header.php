...
<!--<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	...
	<body class="homepage">
		<!-- Header -->
		<div id="header" style="background-color:#04225e;color:#a06450;" >
			<div class="container">

				<!-- Logo -->
				<div id="logo">
					<h1><a href="index3.php"><img src="images/sarva.png" width="350" height="105" alt="Logo" /></a>                  
                    </h1>
				</div>
			</div>
            <!-- Nav -->
				<nav id="nav" style="background-color:#04225e;color:#04225e;">
					<ul>
						<li
                        <?php
						...
						?>>
            <a href="index3.php" style="color:#a06450;font-weight: bold;">
            Home</a></li>
